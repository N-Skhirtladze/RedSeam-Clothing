...
function Products () {
    ...
    return (
      <>
        <Header />
        <Filtration setCriteria={setCriteria} firstInputProps={register("from")} secondInputProps={register("to")} handleSubmit={handleSubmit} setFormData={setFormData}  from={apiData.meta?.from} to={apiData.meta?.to} total={apiData.meta?.total}/>
